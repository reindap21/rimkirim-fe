<template>
  ...
  <section class="relative overflow-visible h-[695px] mt-[134px] pt-[145px]">
    <!-- IMAGE LEFT -->
    <img src="https://i.ibb.co.com/F4DKtTNy/hero-left.png" alt=""
      class="pointer-events-none absolute left-0 top-1/2 -translate-y-1/2 w-[260px] md:w-[320px] xl:w-[477px]" />

    <!-- IMAGE RIGHT -->
    <img src="https://i.ibb.co.com/v4w0Xst2/image-15.png" alt=""
    ...
    <div class="relative z-10 max-w-5xl mx-auto px-6 flex flex-col items-center justify-center gap-4">
      <div
        ...
        <div class="relative flex gap-0.5 max-w-[232px] whitespace-nowrap overflow-hidden">
          ...
          <span
            class="absolute right-0 top-0 h-full w-4 bg-gradient-to-l from-[#FAFAFC] to-transparent pointer-events-none"></span>
        </div>
