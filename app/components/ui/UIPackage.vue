...
const props = withDefaults(defineProps<UIPackage>(), {
  currency: "",
});
...
const onSelectedFiles = async (event) => {
  ...
  uploadedFiles.value = (res as any).files;
};
...
onMounted(() => {
  ...
  packagingType.value = packagingTypeOptions.value.find(
    (o) => o.code === p.packagingType,
  );
...
<template>
  <div
    class="flex flex-col gap-6 bg-neutral-10 border border-neutral-40 rounded-[12px]"
  >
    <div
      class="flex items-center justify-between gap-6 bg-neutral-20 p-6 h-[92px]"
      :class="
        !showDetails ? 'rounded-[11px]' : 'rounded-tl-[11px] rounded-tr-[11px]'
      "
    >
    ...
    <div class="flex flex-col gap-6 pb-6" v-if="showDetails">
        ...
        <div class="relative flex items-start gap-6">
          ...
          <div class="flex-[1] relative">
            <div class="flex flex-col gap-[6px]">
              <label class="text-[14px] font-medium text-neutral-90"
          ...
          <div class="flex-[1]">
            <div class="flex flex-col gap-[6px]">
              ...
              <div class="relative h-[46px]">
                ...
                <InputIcon
                  class="absolute right-[1px] top-[9px] h-[44px] w-[45px] bg-neutral-20 text-neutral-70 flex items-center justify-center rounded-tr-[5px] rounded-br-[5px]"
                >
                  KG
                </InputIcon>
              </div>
      ...
      <div class="px-6">
        <div
          class="flex items-center justify-between bg-neutral-20 p-4 border-b border-[#F6F6FA]"
        >
          <div class="flex gap-3">
            <div
              class="flex justify-center items-center w-[44px] h-[44px] bg-white rounded-[8px]"
            >
          ...
          >
            <div
              class="text-[18px] leading-[26px] font-bold w-full text-center"
            >
      ...
      <div class="px-6 flex flex-col gap-2">
        <div
          class="flex items-center gap-1 text-[14px] font-medium text-neutral-90"
        >
          Package Photos
