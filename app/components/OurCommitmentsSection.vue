<template>
    ...
    <div
      class="bg-[#FAFAFC] rounded-[24px] px-[100px] py-10 flex flex-col gap-8"
    >
      <div class="flex flex-col items-center justify-center gap-2">
        <span
          class="inline-block px-5 py-2 h-[38px] text-[14px] font-medium rounded-full bg-white border border-[#F5F5F5] text-[#1E1E1E]"
          >Our Commitments</span
        >
        <h2 class="text-[40px] leading-[48px] font-bold text-[#1E1E1E]">
          Simple, Clear, Trust-Building
        </h2>
      </div>
