...
<template>
  <section class="flex flex-col relative gap-6 max-w-7xl mx-auto px-6 pt-28 pb-24">
            ...
            <div class="flex items-center p-6 gap-6 bg-neutral-20 rounded-tl-[12px] rounded-tr-[12px]">
              ...
              <div class="flex-1 flex items-center justify-between gap-2">
                ...
                <div class="flex items-center gap-2 py-1 px-3 rounded-full"
                  :class="isReceiverSameAsSender ? 'bg-primary text-neutral-100' : 'bg-white text-neutral-70'">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 px-6">
              ...
              <div class="flex flex-col gap-6">
                ...
                <div class="flex flex-col gap-[6px]">
                  ...
                  <div class="relative">
                    <InputText nostyle name="senderContactName" type="text" placeholder="e.g. Dzulfan Fadli"
                      class="w-full pr-12" />
              ...
              <div class="flex flex-col gap-6">
                ...
                <div class="flex gap-6">
                  ...
                  <div class="flex-1 flex flex-col gap-[6px]">
                    <label class="font-medium text-neutral-90">Active International Phone Number [Origin]</label>
                    <div class="relative">
                      <InputIcon
                        class="absolute top-[9px] h-[44px] left-[1px] flex items-center justify-center py-3 w-[51px] bg-neutral-20 text-neutral-70 rounded-tl-[5px] rounded-bl-[5px]">
                        +62
                  ...
                  <!-- Destination -->
                  <div class="flex-1 flex flex-col gap-[6px]">
                    <label class="font-medium text-neutral-90">Active International Phone Number [Destination]</label>
                    <div class="relative">
                      <InputIcon
                        class="absolute top-[9px] h-[44px] left-[1px] flex items-center justify-center py-3 w-[51px] bg-neutral-20 text-neutral-70 rounded-tl-[5px] rounded-bl-[5px]">
                        +62
    ...
    <template v-else>
      ...
      <div class="w-[500px] mx-auto flex flex-col gap-6 bg-neutral-20 rounded-[16px] mt-16 px-6 py-8">
